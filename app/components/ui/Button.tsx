...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md mobile-text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-bolt-elements-borderColor disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
      ...
      size: {
        default: 'mobile-btn-default',
        sm: 'mobile-btn-sm',
        lg: 'mobile-btn-lg',
        icon: 'mobile-btn-icon',
      },
    },
    defaultVariants: {
      variant: 'default',
